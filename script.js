...
// =========================
// FUNÇÃO AUXILIAR (CORREÇÃO DE DATA)
// =========================
...
async function carregarTurmas() {
    ...
    const turmas = [
        ...new Set(dados.map(item => item.turma))
    ];
...
async function carregarCalendario() {
    ...
    renderizarCalendario(provasTurma, mesAtual);
    renderizarListaMobile(provasTurma, mesAtual);
}
...
function renderizarCalendario(provas, mes) {
    ...
    for (let dia = 1; dia <= totalDias; dia++) {
        ...
        const provasDia = provas.filter(prova => {
            ...
            const data = parseDate(prova.data);
        ...
        provasDia.forEach(prova => {
            ...
            const provaEl = document.createElement("div");
...
function renderizarListaMobile(provas, mes) {

    const lista = document.getElementById("listaMobile");
    lista.innerHTML = "";
